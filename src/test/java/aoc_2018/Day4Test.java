...
public class Day4Test {
    ...
    public static final Stream<String> TEST_DATA = Stream.of(
    ...
    @Test
    public void lol1() {
        Day4.Guard mostAsleepGuard = Day4.findMostAsleepGuard(TEST_DATA);
        System.out.println("Found guard #" + mostAsleepGuard.getId() + " with a sleep duration of: " + mostAsleepGuard.getSleepDuration().toString());
    ...
    @Test
    public void lol2() {
        Day4.Guard guard = Day4.getMostFrequentlyAsleepAtSameMinute(TEST_DATA);
        Map.Entry<Integer, Integer> maxSleepMinute = guard.getMaxSleepMinute();
        System.out.println("Found guard #" + guard.getId() + " with a sleep minute: " + maxSleepMinute.getKey() + " at score: " + maxSleepMinute.getValue());
        System.out.println("stats:\n" + guard.printScores());
